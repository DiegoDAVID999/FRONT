...
//             {/* Mostrar enlace a Productos solo para administradores */}
//             {userRole === "admin" && (
//               <li className="nav-item">
...
//                 {username || "Usuario"} ({userRole === "admin" ? "Administrador" : "Vendedor"})
//               </span>
//               <button className="btn btn-warning fw-bold ms-lg-1 mt-2 mt-lg-0" onClick={() => setShowModal(true)}>
//                 <i className="bi bi-box-arrow-right"></i> Cerrar Sesión
//               </button>
//             </li>
//           </ul>
      ...
      <div className="container-fluid">
        ...
        <div className="collapse navbar-collapse justify-content-end" id="navbarNav">
          <ul className="navbar-nav">
            ...
            {/* Administración de usuarios solo visible para administradores */}
            {/* {isAdmin && (
              <li className="nav-item">
